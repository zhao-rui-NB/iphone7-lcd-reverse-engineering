...
always @(posedge clk_byte_fr_i) begin
  if (reset_byte_fr_n_i == 1'd0) begin
    ...
    case (data_sel_i)
      ...
      4'd3   : data_o <= bd3_o[7:0];
      4'd4   : data_o <= bd0_o[15:8];
      4'd5   : data_o <= bd1_o[15:8];
      4'd6   : data_o <= bd2_o[15:8];
      default: data_o <= bd3_o[15:8];
    endcase
  end
end
