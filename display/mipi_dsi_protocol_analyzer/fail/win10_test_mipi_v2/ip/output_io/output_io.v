...
//
// Verific Verilog Description of module output_io
//
module output_io (ddr_output_data, ddr_output_dout, ddr_output_clkout, 
            ddr_output_refclk, ddr_output_reset) /* synthesis sbp_module=true */ ;
