...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll_sys_clk -lang verilog -synth lse -bus_exp 7 -bb -arch sn5w00 -type pll -fin 50 -fclkop 100 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -phases 90 -phase_cntl STATIC -fb_mode 1 -fdc C:/Users/rui/Desktop/win10_crosslink/win10_test_mipi_v2/ip/clock/pll_sys_clk/pll_sys_clk.fdc  */
/* Mon Jul 14 11:31:01 2025 */


`timescale 1 ns / 1 ps
module pll_sys_clk (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
