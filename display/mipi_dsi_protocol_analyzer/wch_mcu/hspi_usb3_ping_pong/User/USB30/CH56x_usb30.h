...
extern UINT8V last_send_packet;
...
extern UINT8V usb_sending_flag;
extern UINT8V usb_ep1_upload_done_flag;
extern UINT8V ping_pong_state;
extern UINT32V tx_addr_ptr;
...
extern __attribute__((aligned(16))) UINT8 buffer0[4096] __attribute__((section(".DMADATA")));
extern __attribute__((aligned(16))) UINT8 buffer1[4096] __attribute__((section(".DMADATA")));
